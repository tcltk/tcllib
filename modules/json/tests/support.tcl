...
set  ERR(escape3-critcl) {syntax error 0 bytes before end, around ``%''}

set FAIL(escape4)        {["\."]}
set  ERR(escape4-tcl)    {unexpected token "END" at position 0; expecting VALUE}
set  ERR(escape4-critcl) {syntax error 0 bytes before end, around ``.''}

set FAIL(escape5)        {{"a":"\%"}}
set  ERR(escape5-tcl)    "unexpected token \"}\" at position 4; expecting VALUE"
set  ERR(escape5-critcl) {syntax error 0 bytes before end, around ``%''}

set FAIL(escape6)        {{"a":"\."}}
set  ERR(escape6-tcl)    "unexpected token \"}\" at position 4; expecting VALUE"
set  ERR(escape6-critcl) {syntax error 0 bytes before end, around ``.''}

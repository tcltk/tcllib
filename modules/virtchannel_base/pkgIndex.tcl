...
package ifneeded tcl::chan::memchan 1.0.1  [list source [list [file join $dir memchan.tcl]]]
...
package ifneeded tcl::chan::string 1.0.1   [list source [list [file join $dir string.tcl]]]
package ifneeded tcl::chan::textwindow 1   [list source [list [file join $dir textwindow.tcl]]]
package ifneeded tcl::chan::variable 1.0.1 [list source [list [file join $dir variable.tcl]]]

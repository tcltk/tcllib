...
package ifneeded tcl::chan::memchan 1.0.1  [list source [file join $dir memchan.tcl]]
...
package ifneeded tcl::chan::variable 1.0.1 [list source [file join $dir variable.tcl]]

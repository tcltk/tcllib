...
proc ::ftpd::config {args} {
	...
	{logCmd {::ftpd::logStderr} {Callback for log information generated by the FTP engine.}} \
	{fsCmd  {::ftpd::fsFile::fs} {Callback to connect the engine to the filesystem it operates on.}}]]
    return
}
...
proc ::ftpd::server {{myaddr {}}} {
	...
	socket -server ::ftpd::accept $port -myaddr $myaddr
    } else {

...
[//000000004]: # (SASL::XGoogleToken\(n\) 1\.0\.2 tcllib "Simple Authentication and Security Layer \(SASL\)")
...
package require SASL::XGoogleToken ?1\.0\.2?  
...
Trackers](http://core\.tcl\.tk/tcllib/reportlist) and specify *sasl* as the
category\.

...
[//000000004]: # (tcl::chan::null\(n\) 1\.1 tcllib "Reflected/virtual channel support")
...
package require tcl::chan::null ?1\.1?  
...
Trackers](http://core\.tcl\.tk/tcllib/reportlist) and specify *virtchannel*
as the category\.
